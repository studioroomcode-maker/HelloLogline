...
// ─────────────────────────────────────────────
// 구조 분석 (Plot Point Mapping)
// 참고 원전:
//   Field, S. (1982). Screenplay. Dell. — 3막 구조, p.25/75/85 플롯 포인트
//   Snyder, B. (2005). Save the Cat. Michael Wiese. — 15비트 시스템
//   McKee, R. (1997). Story. HarperCollins. — 가치 전하, 씬-시퀀스-액트
//   Hauge, M. (2001). Writing Screenplays That Sell. HarperCollins. — 5전환점
//   Truby, J. (2007). The Anatomy of Story. FSG. — 22단계 구조
// ─────────────────────────────────────────────
...
// ─────────────────────────────────────────────
// 테마 & 감정선 분석 (Theme & Emotional Arc)
// 참고 원전:
//   Egri, L. (1946). The Art of Dramatic Writing. Simon & Schuster. — 도덕적 전제
//   McKee, R. (1997). Story. HarperCollins. — 컨트롤링 아이디어
//   Truby, J. (2007). The Anatomy of Story. FSG. — 도덕적 논증, 주제
//   Vogler, C. (1992). The Writer's Journey. Michael Wiese. — 테마적 기능
// ─────────────────────────────────────────────
...
// 씬 리스트 / 스텝 아웃라인
// 참고 원전:
//   Field, S. (1982). Screenplay. Dell. — 씬 분석
//   Truby, J. (2007). The Anatomy of Story. FSG. — 씬 weaving
//   McKee, R. (1997). Story. HarperCollins. — 씬-시퀀스-액트 계층
// ─────────────────────────────────────────────
