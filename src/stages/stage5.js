...
[액션 라인]:
  현재형·3인칭·시각적 언어. 감정은 행동으로만. 한 문단 3~4줄 이내.
...
작성 원칙:
  ...
  - 각 막 시작 전 막 제목 표기: "1막 — 설정", "2막 — 대결", "3막 — 해결"
  - JSON·마크다운·설명 없이 순수 시나리오 텍스트만 출력
  - HTML 엔티티(&nbsp; &amp; &lt; 등) 절대 사용 금지. 공백과 들여쓰기는 일반 스페이스·탭 문자만 사용.
  - FADE IN/FADE OUT 등 전환 지시어는 일반 텍스트로만 표기

순수 시나리오 텍스트만 출력하세요. 설명·주석·마크다운 없이 씬부터 바로 시작하세요.`;
