...
export default function Stage9Content({
    ...
    `}</style>
      ...
      <div style={{ marginBottom: 22, padding: "12px 14px", borderRadius: 10, background: "rgba(69,183,209,0.05)", borderLeft: "2px solid rgba(69,183,209,0.4)" }}>
        <div style={{ fontSize: 12, color: "var(--c-tx-50)", lineHeight: 1.65 }}>
          <strong style={{ color: "rgba(69,183,209,0.85)" }}>Deep Analysis (선택 단계)입니다.</strong> 학술 이론·신화구조·전문가 패널로 이야기의 이론적 기반을 점검하세요.
          메인 파이프라인(1→8)을 끝낸 뒤 보강용으로 쓰셔도 되고, 언제든 들렀다 가셔도 됩니다.
        </div>
      </div>
