...
[최우선 지시] 입력 컨텍스트에 "확정된 핵심 설계 (Stage 2 — 이야기 엔진)" 블록이 있다면, 그 블록의 Want/Need/적대자/스테이크/테마 5축은 이미 작가가 확정한 사실입니다. 주인공의 want/need 필드는 핵심 설계의 Want/Need와 모순되지 않도록 발전시키고(동의어로 풀어쓰는 것은 허용, 다른 욕망으로 바꾸는 것은 금지), 적대자/조연 캐릭터는 핵심 설계의 적대자 정의와 거울 관계를 그대로 따르세요. 5축을 무시하고 새 인물 욕망을 창작하지 마세요.
